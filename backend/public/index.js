...
document.getElementById("entryForm").addEventListener("submit", function (event) {
  ...
  const url = editingId
    ? `https://clinical-metrics-api.onrender.com/entries/${editingId}`
    : "https://clinical-metrics-api.onrender.com/entries";
...
function editEntry(id) {
  fetch(`https://clinical-metrics-api.onrender.com/entries/${id}`)
    .then(response => {
...
function deleteEntry(id) {
  ...
  fetch(`https://clinical-metrics-api.onrender.com/entries/${id}`, { method: "DELETE" })
    .then(response => {
